...
def register():
    ...
    if request.method == "POST":
        ...
        db.execute('insert into users (name, password, expert, admin) values (%s, %s, %s, %s)', (name, hashed_password, '0', '0'))
...
def ask():
    ...
    db.execute('select id, name from users where expert is True')
